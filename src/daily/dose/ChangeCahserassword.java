 ...
 * @author alaa
 */
public class ChangeCahserassword extends javax.swing.JFrame {

    PreparedStatement ps;
    ResultSet rs;

    public ChangeCahserassword() {
        initComponents();
        showTableData();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Daily Dose coffe - Manage Accounts");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String usre_name = user.getText();
        String password_user = password.getText();

        PreparedStatement ps;
        String query = "UPDATE `users` SET `psswd`=? WHERE `userName`=?";
        try {
            ps = DbConnect.getconnection().prepareStatement(query);
            ps.setString(2, usre_name);
            ps.setString(1, password_user);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String query = "INSERT INTO `casherUser`(`userName`, `psswd`) VALUES (?,?)";
        try {
            ps = DbConnect.getconnection().prepareStatement(query);
    ...
    public void showTableData() {
        try {
            String query = "SELECT * FROM `casherUser`";
            ps = DbConnect.getconnection().prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeCahserassword().setVisible(true);
            }
        });
    }
