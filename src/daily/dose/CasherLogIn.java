 ...
 * @author alaa
 */
public class CasherLogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Daily Dose Coffe - Casher LogIN");
        ...
        jLabelRegister.setText("  Continue as Admin");
    ...
    private void logInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logInActionPerformed
        ...
        String query = "SELECT * FROM `casherUser` WHERE `userName` =?  AND `psswd`=?";
        String queryI = "INSERT INTO `activityLog`(`name`, `dateAndTime`) VALUES (?,?)";
//        String queryI = "INSERT INTO `activirylog`(`name`, `date and time`) VALUES (?,?) ";
        ...
        try {
            ...
            rs = ps.executeQuery();
            if (rs.next()) {
                DailyDoseCasher casher = new DailyDoseCasher();
